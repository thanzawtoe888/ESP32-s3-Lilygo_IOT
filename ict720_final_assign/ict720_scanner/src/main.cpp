...
// settings
#define WIFI_SSID         "Xiaomi2020Laptop"
#define WIFI_PASSWD       "11112222"
#define MQTT_BROKER       "192.168.137.1"
#define MQTT_PORT         1883
#define MQTT_CLIENT_ID    "thanZawToe@@11##"
// pattern ict720/<group>/<station>/<type>
#define MQTT_TOPIC_BEAT   "ict720/luca/esp321/beat"
#define MQTT_TOPIC_DATA   "ict720/luca/esp321/data"
#define MQTT_TOPIC_CMD    "ict720/luca/esp321/cmd"
...
void on_message(char* topic, byte* payload, unsigned int length) {
  ...
  //   mqtt_client.publish("ict720/luca/esp32/resp", buf);
  // }
}